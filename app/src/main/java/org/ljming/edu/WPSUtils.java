...
public class WPSUtils {
    ...
    public class Reciver {
        ...
        public static final String ACTION_SAVE = "cn.wps.moffice.unitFile.save";// 保存广播
        public static final String ACTION_CLOSE = "cn.wps.moffice.unitFile.close";// 关闭文件广播
    }

    public static boolean openFile(Context context, String path) {
        Intent intent = new Intent();
        Bundle bundle = new Bundle();
        bundle.putString(WPSUtils.OPEN_MODE, OpenMode.NORMAL); // 打开模式
        bundle.putBoolean(WPSUtils.SEND_CLOSE_BROAD, true); // 关闭时是否发送广播
        bundle.putString(WPSUtils.THIRD_PACKAGE, context.getPackageName()); // 第三方应用的包名，用于对改应用合法性的验证
        bundle.putBoolean(WPSUtils.CLEAR_TRACE, true);// 清除打开记录
